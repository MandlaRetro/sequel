...
namespace MyTimesheet
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = @"Server=sql101labs1793591179000.westeurope.cloudapp.azure.com;Database=sql101.mandla.masombuka;User Id=mandlamasombuka;Password=Mandla_21!@#;";
